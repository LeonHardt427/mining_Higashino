...
#     if os.path.exists(doc_2_vec+'doc_dic_filter.dict') is True:
#         os.remove(doc_2_vec+'doc_dic_filter.dict')
#     dictionary.save(doc_2_vec+'doc_dic_filter.dict')
#
#     doc_vectors = [dictionary.doc2bow(text) for text in corpus]
#     if os.path.exists(doc_2_vec+'doc_dic_filter.mm') is True:
#         os.remove(doc_2_vec+'doc_dic_filter.mm')
#     corpora.MmCorpus.serialize(doc_2_vec+'doc_dic_filter.mm', doc_vectors)
#
# # -----------------------------------
# eyi
